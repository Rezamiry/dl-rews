...
def get_dl_predictions(resids, model_type, kk):
    ...
    model_name = "train_amit/results/run12/run12.pkl"
...
with open("reza_apply_test_envn_uncen.pickle", "wb") as f:
    pickle.dump(preds_envn, f)

    
with open("reza_apply_test_whiten_uncen.pickle", "wb") as f:
    pickle.dump(preds_whiten, f)

    
with open("reza_apply_test_demn_uncen.pickle", "wb") as f:
