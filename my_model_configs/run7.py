...
x = Conv1D(filters=n_kernels, strides=stride_size, kernel_size=kernel_size,  padding='valid')(input_x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1D(filters=2*n_kernels,  kernel_size=kernel_size,  padding='valid')(x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = MaxPooling1D(pool_size=pool_size_param)(x)
x = Dropout(dropout_percent)(x)

x = Conv1D(filters=4*n_kernels,  kernel_size=kernel_size,  padding='valid')(x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1D(filters=8*n_kernels,  kernel_size=kernel_size,  padding='valid')(x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = MaxPooling1D(pool_size=pool_size_param)(x)
x = Dropout(dropout_percent)(x)

x = Conv1D(filters=16*n_kernels,  kernel_size=kernel_size,  padding='valid')(x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
x = Conv1D(filters=32*n_kernels,  kernel_size=kernel_size,  padding='valid')(x)
x = BatchNormalization()(x)
x = Activation('relu')(x)
