...
x = LSTM(mem_cells, return_sequences=True, kernel_initializer=initializer_param)(input_x)
x = Dropout(dropout_percent)(x)

x = LSTM(mem_cells, return_sequences=True, kernel_initializer=initializer_param)(x)
x = Dropout(dropout_percent)(x)

x = LSTM(mem_cells, return_sequences=True, kernel_initializer=initializer_param)(x)
x = Dropout(dropout_percent)(x)

x = LSTM(mem_cells2, kernel_initializer=initializer_param)(x)
x = Dropout(dropout_percent)(x)
