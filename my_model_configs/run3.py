...
# define model
model = Sequential()
model.add(ConvLSTM2D(filters=64, kernel_size=(1,12), activation='relu',return_sequences=True, input_shape=(n_steps, 1, n_length, n_features)))
model.add(Dropout(0.2))
model.add(ConvLSTM2D(filters=128, kernel_size=(1,12), activation='relu'))
