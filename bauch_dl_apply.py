...
for index, filepath in enumerate(glob("../test_models/seirx_1500/data/resids/*")):
  print("{} - doing prediction for {}".format(index, filepath))
  filepath_out = f"../test_models/seirx_1500/data/ml_preds_test/pred_{filepath.split('/')[-1]}"
  ts_len=1500
